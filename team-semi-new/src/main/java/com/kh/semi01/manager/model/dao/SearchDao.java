...
private Properties prop = new Properties();
	...
	public int selectReviewCountByDate(Connection conn,int productNo, String content) {
		int result = 0;
		PreparedStatement pstmt = null;
		ResultSet rset = null;
	...
	public ArrayList<Review> selectReviewListByDate(Connection conn,int productNo,String content,PageInfo pi){
		ArrayList<Review> list = new ArrayList<>();
		PreparedStatement pstmt = null;
		ResultSet rset = null;
