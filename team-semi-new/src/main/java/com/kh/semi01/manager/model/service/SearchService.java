...
public class SearchService {
	...
	public int selectReviewCountByDate(int productNo, String content) {
		...
		int count = new SearchDao().selectReviewCountByDate(conn,productNo, content);
	...
	public ArrayList<Review> selectReviewListByDate(int productNo,String content,PageInfo pi){
		...
		ArrayList<Review> list = new SearchDao().selectReviewListByDate(conn, productNo, content, pi);
