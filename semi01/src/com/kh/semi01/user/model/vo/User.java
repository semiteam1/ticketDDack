...
public class User {
	...
	private String enrollDate;		// 회원가입일 => 입출력을 자유롭게 하기 위해서 String으로
	...
	public User(int userNo, String userId, String userPwd, String userName, String userBirth, String interestMovie,
			String interestDisplay, String interestShow, String email, String phone, String grade, String enrollDate,
			String status) {
		super();
		this.userNo = userNo;
		this.userId = userId;
	...
	public String toString() {
		return "User [userNo=" + userNo + ", userId=" + userId + ", userPwd=" + userPwd + ", userName=" + userName
				...
				+ ", grade=" + grade + ", enrollDate=" + enrollDate + ", status=" + status + "]";
	}
