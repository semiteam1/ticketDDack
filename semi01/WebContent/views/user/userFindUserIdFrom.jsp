                ...
                <div class="id_pwd_input" >
                    <div class="line">
                        <img src="resource/이미지자료/로그인.png" id="newMember_img">
                            <input type="name" id="new_user" class="fine_pwd" name="fine_pwd" placeholder="이름" required>
                    </div>
                    <div class="line">
		...
		<form action="<%=contextPath%>/userCheck.ur?type=2"  method="post">
              <div id="tab2" class="tab-content">
                <div class="id_pwd_input">
                    <div class="line">
                        <img src="resource/이미지자료/로그인.png" id="newMember_img">
                            <input type="name" id="new_user" class="fine_pwd2" name="fine_pwd" placeholder="이름" required>
                    </div>
                    <div class="line">
                        <img src="resource/이미지자료/달력2.PNG" id="newMember_img">
                            <input type="number" id="new_user" name="fine_bday" placeholder="생년월일" required>
